...
class CustomHabitsyearreport extends StatefulWidget {
  CustomHabitsyearreport({Key? key}) : super(key: key);

  @override
  _CustomHabitsyearreportState createState() => _CustomHabitsyearreportState();
}

class _CustomHabitsyearreportState extends State<CustomHabitsyearreport> {
  final random = Random();
