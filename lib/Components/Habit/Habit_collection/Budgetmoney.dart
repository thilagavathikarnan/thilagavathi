...
class Budgetmoneypage extends StatefulWidget {
  @override
  State<Budgetmoneypage> createState() => _BudgetmoneypageState();
}

class _BudgetmoneypageState extends State<Budgetmoneypage> {
  final random = Random();
            ...
            child: Column(
              children: [
                Expanded(
                  ...
                  itemCount: Budgetmoneylist.length,
                  itemBuilder: (context, index) {
                    Budgetmoney budgetmoney = Budgetmoneylist[index];
                    return Padding(
                        ...
                        onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => Addhabitsintrent(
                              '2',
                              Budgetmoneylist[index].title,
                              Budgetmoneylist[index].Subtitle,
                            ),
                          ),
                        ),
                        child: Container(
                          ...
                          child: Center(
                            child: ListTile(
                              ...
                              subtitle: Text(Budgetmoneylist[index].Subtitle),
                              leading: IconButton(
                                icon: Budgetmoneylist[index].isselected
                                    ? Icon(Icons.check)
                                    : Icon(Icons.check_box_outline_blank),
                                onPressed: (() {
                                  setState(() {
                                    if (Budgetmoneylist[index].isselected) {
                                      Budgetmoneylist[index].isselected = false;
                                    } else {
                                      Budgetmoneylist[index].isselected = true;
                                    }
                                  });
                                }),
                              ),
