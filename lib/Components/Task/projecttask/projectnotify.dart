...
class projectnotify extends StatefulWidget {
  const projectnotify({super.key});

  @override
  State<projectnotify> createState() => _projectnotifyState();
}

class _projectnotifyState extends State<projectnotify> {
  final random = Random();
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child: FloatingActionButton(
                        heroTag: "google",
                        backgroundColor: Color(0xff3b4682),
