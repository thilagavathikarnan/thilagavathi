...
import 'package:habittrackergad/Components/Task/Addteam.dart';
...
class projectteam {
  ...
  List<Afternoontask>? afterNoonTask;
...
class projectassignedtoyou extends StatefulWidget {
  const projectassignedtoyou({super.key});

  @override
  State<projectassignedtoyou> createState() => _projectassignedtoyouState();
}

class _projectassignedtoyouState extends State<projectassignedtoyou> {
  final random = Random();
