...
import 'cashcategory.dart';

class CashoutAdd extends StatefulWidget {
  @override
...
class Homepage extends State<CashoutAdd> {
  //////////////////////contact
  ...
  List<String> _items = ['Party Name(Contact)', 'Cash', "other"];
